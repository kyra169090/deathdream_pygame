...
city_part_5_2_5 = BusDriver(pygame.image.load('../assets/images/scenes/location5/city_part_5_2_5.jpg'), frame_folder='../assets/images/scenes/location5/png/window_frames', position=(90, 313))
...
city_part_5_2_4.boxes[0].next_scene = city_part_5_2_2
